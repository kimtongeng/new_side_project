...
namespace Modules\ExchangeCurrency\Providers;
...
class ExchangeCurrencyServiceProvider extends ServiceProvider
{
    /**
     * @var string $moduleName
     */
    protected $moduleName = 'ExchangeCurrency';

    /**
     * @var string $moduleNameLower
     */
    protected $moduleNameLower = 'exchangecurrency';
    ...
    {
        View::composer('sale_pos.receipts.classic', function ($view) {
            $view->setPath(base_path('Modules/ExchangeCurrency/Resources/views/overrides/classic.blade.php'));
        });
        ...
        // Add override view path


        // \View::composer('*', function () {
        //     static $menuAdded = false;
        ...
        //     if (!$menu) {
        //         \Menu::make('admin-sidebar-menu', function ($menu) {
        ...
        //     $menu->add([
        //         'title' => __('exchange_currency.exchange_currency'),
        //         'url' => action([\Modules\ExchangeCurrency\Http\Controllers\ExchangeCurrencyController::class, 'index']),
        //         'icon' => 'fa fa-exchange',
        //         'active' => request()->segment(1) === 'exchange_currency',
        //         'order' => 86,
        //     ]);
    ...
    public function register()
    {
        ...
        $this->loadViewsFrom(resource_path('modules/ExchangeCurrency/Resources/views'), 'ExchangeCurrency');
    }
    ...
    public function registerViews()
    {
        ...
        $viewPath = resource_path('views/modules/ExchangeCurrency');
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/modules/ExchangeCurrency';
        }, config('view.paths')), [$sourcePath]), 'ExchangeCurrency');
    }
    ...
    public function registerTranslations()
    {
        ...
        // }
        $langPath = resource_path('lang/modules/ExchangeCurrency');

        if (is_dir($langPath)) {
            $this->loadTranslationsFrom($langPath, 'ExchangeCurrency');
        } else {
            $this->loadTranslationsFrom(__DIR__ . '/../Resources/lang', 'ExchangeCurrency');
        }
    }
