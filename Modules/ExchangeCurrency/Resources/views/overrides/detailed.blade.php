	...
	<div class="col-md-6 invoice-col width-50">
		<table class="table-no-side-cell-border table-no-top-cell-border width-100 table-slim">
			<tbody>
				...
				<!-- Total -->
				<tr>
					<th style="background-color: #357ca5 !important; color: white !important" class="font-23 padding-x-10">
						{!! $receipt_details->total_label !!}
					</th>
					<td class="text-right font-23 padding-x-10" style="background-color: #357ca5 !important; color: white !important">
						{{$receipt_details->total}}
					</td>
				</tr>

				@foreach ($currency_exchange as $key => $val)
					<tr>
						<th style="background-color: #357ca5 !important; color: white !important" class="font-23 padding-x-10">
							{{ $receipt_details->total_label }} ({{ $val->symbol }})
						</th>
						<td class="text-right font-23 padding-x-5" style="background-color: #357ca5 !important; color: white !important">
