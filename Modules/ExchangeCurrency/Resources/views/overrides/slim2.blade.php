...
<html lang="en">
    ...
    <body>
        <div class="ticket">
			...
			<div class="flex-box">
				<p class="width-50 text-left">
					<strong>	{{ $receipt_details->total_label }} ({{ $val->symbol }})</strong>
				</p>
				<p class="width-50 text-right">
					<strong>{{ format_converted_currency($val->symbol, $val->exchange_rate, $receipt_details->total_unformatted) }}</strong>
				</p>
			</div>
				@endforeach
