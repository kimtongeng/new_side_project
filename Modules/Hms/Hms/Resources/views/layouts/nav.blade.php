    ...
    <nav class="navbar-default tw-transition-all tw-duration-5000 tw-shrink-0 tw-rounded-2xl tw-m-[16px] tw-border-2 !tw-bg-white">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                @endcan
                <ul class="nav navbar-nav">
                    <li @if(request()->segment(1) == 'hms' && in_array(request()->segment(2), ['reports', 'booking-stats-report', 'booking-payment-report'])) class="active" @endif><a href="{{action([Modules\Hms\Http\Controllers\HmsReportController::class, 'index'])}}">@lang('hms::lang.reports')</a></li>
                </ul>
