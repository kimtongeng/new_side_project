@extends('layouts.app')
@section('title', __('hms::lang.booking_stats_report'))

@section('content')
    @include('hms::layouts.nav')
    <section class="content-header">
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black" > @lang('hms::lang.booking_stats_report')
        </h1>
    ...
    <section class="content">
        ...
        @component('components.filters', ['title' => __('report.filters'), 'closed' => false])
            <div class="row">
                <div class="col-md-3">
                    {!! Form::open([
                        'url' => action([\Modules\Hms\Http\Controllers\HmsReportController::class, 'bookingStatsReport']),
                        'method' => 'get',
                    ]) !!}
