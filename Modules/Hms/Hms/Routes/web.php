...
Route::middleware('web', 'auth', 'language', 'AdminSidebarMenu')->prefix('hms')->group(function () {
    ...
    Route::get('/booking-payment-report', [Modules\Hms\Http\Controllers\HmsReportController::class, 'bookingPaymentReport'])->name('hms.booking_payment_report');
    Route::get('/booking-stats-report', [Modules\Hms\Http\Controllers\HmsReportController::class, 'bookingStatsReport'])->name('hms.booking_stats_report');
