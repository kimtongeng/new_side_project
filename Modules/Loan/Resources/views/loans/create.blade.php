            ...
            <div class="col-lg-8 col-md-12">
                ...
                @component('components.widget', ['class' => 'box-primary', 'title' => __('Loan::lang.recipient_type') . ' & ' . __('Loan::lang.branch')])
                    <div class="row">
                        ...
                        <!-- User -->
                        <div class="col-md-6" id="user_field" style="display: none;">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                {!! Form::label('account_id', __('Loan::lang.account') . ':*') !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('start_date', @format_date('now'), ['id' => 'start_date', 'class' => 'form-control', 'required' => true]) !!}
                            </div>
                        </div>
