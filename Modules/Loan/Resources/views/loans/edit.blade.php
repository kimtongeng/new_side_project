...
@section('content')
    ...
    <style>
        ...
        .loan-card:hover {
            ...
            box-shadow: 0 12px 30px rgba(16, 185, 129, 0.08), 0 20px 40px rgba(0, 0, 0, 0.04) !important;
        }
    ...
    <div class="premium-wrapper">
            ...
            <div class="row mb-5">
                <div class="col-md-12 text-center">
                    <h1 class="display-4 font-weight-bold"
                        style="background: linear-gradient(135deg, #10b981, #059669); -webkit-background-clip: text; -webkit-text-fill-color: transparent; letter-spacing: -0.5px;">
                        ✏️ {{ __('Loan::lang.edit_loan') }}</h1>
                    <p class="lead text-muted" style="font-size: 1.1rem; font-weight: 400;">
                        {{ __('Loan::lang.manage_loan_details') }}</p>
                    <div class="mx-auto"
                        style="width: 60px; height: 4px; background: linear-gradient(135deg, #10b981, #059669); border-radius: 2px;">
                    </div>
                </div>
            </div>
        ...
        'onchange' => 'toggleRecipientFields()'
                                ...
                                <div class="col-md-6 mb-4" id="customer_field"
                                    style="{{ $loan->user_id ? 'display: none;' : '' }}">
                                    <div class="form-group">
                                ...
                                <!-- User -->
                                <div class="col-md-6 mb-4" id="user_field"
                                    style="{{ $loan->user_id ? '' : 'display: none;' }}">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('start_date', !empty($loan->start_date) ? @format_date($loan->start_date) : null, ['id' => 'start_date', 'class' => 'form-control form-control-custom', 'required' => true]) !!}
                                    </div>
                                </div>
                        ...
                        <div class="card calculator-card">
                            ...
                            <div class="card-body p-4" style="padding:10px;">
                                ...
                                <div class="calculator-display text-center mb-4">
                                    ...
                                    <h2 id="preview_monthly" class="display-4 font-weight-bold text-success my-2"
                                ...
                                <div class="mb-4">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <span class="text-muted font-weight-medium d-flex align-items-center"><span
                                                class="info-dot bg-success"></span>Principal</span>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <span class="font-weight-bold text-dark d-flex align-items-center"><span
                                                class="info-dot bg-indigo" style="background-color: #10b981;"></span>Total
                                            Payable</span>
                                        <span id="preview_total" class="font-weight-bold text-success"
                                            style="color: #10b981; font-size: 1.15rem;">0.00</span>
                                    </div>

                                    <!-- Visual Stacked Bar -->
                                    <div class="progress"
                                        style="height: 10px; border-radius: 6px; background-color: #f1f5f9; overflow: hidden;">
                                        <div id="preview_principal_bar" class="progress-bar bg-success" role="progressbar"
                                ...
                                <button type="submit" class="btn btn-gradient-success btn-lg btn-block py-3 shadow-lg">
                                    ✔️ {{ __('Loan::lang.update') }}
                                </button>
                            </div>
                        </div>
                    </div>
