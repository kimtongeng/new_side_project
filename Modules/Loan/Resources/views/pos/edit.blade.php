...
<section class="content no-print">
    ...
    @endphp
    {!! Form::open(['url' => action([\Modules\Loan\Http\Controllers\LoanPosEditController::class, 'update'], [$transaction->id]), 'method' => 'post', 'id' => 'edit_pos_sell_form']) !!}
    {{ method_field('PUT') }}
    <div class="row mb-12">
                ...
                <div class="tw-px-3 tw-w-full lg:tw-px-0 lg:tw-pr-0 @if(empty($pos_settings['hide_product_suggestion'])) lg:tw-w-[60%] @else lg:tw-w-[100%] @endif">
                    <div class="tw-shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] tw-rounded-2xl tw-bg-white tw-mb-2 md:tw-mb-8 tw-p-2">
                        <div class="box-body pb-0">
                            ...
                            @include('Loan::pos.partials.pos_form_edit')

                            @include('Loan::pos.partials.pos_form_totals', ['edit' => true])
    ...
    @include('Loan::pos.partials.pos_form_actions', ['edit' => true])
    {!! Form::close() !!}
</section>
