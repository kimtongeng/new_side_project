<script type="text/javascript">
	            ...
	            processResults: function(data) {
	            	return {
			            results: $.map(data, function (value, key) {
			            	var p_name = value.formatted_name ? value.formatted_name : value.name;
			            	var name = value.type == 'variable' ? p_name + ' - ' + value.variation : p_name;
			            	name += ' (' + value.sub_sku + ')';
			                return {
	...
	function initialize_search(element) {
		element.autocomplete({
	        ...
	        var p_name = item.formatted_name ? item.formatted_name : item.name;
	        var string = '<li>' + p_name;
