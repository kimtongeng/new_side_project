...
<section class="content">
	...
	<div class="box box-solid">
		<div class="box-header"> 
			<h4 class="box-title"><strong>@lang('sale.product'): </strong>{!! \App\Utils\ProductUtil::getFormattedProductName($variation->product_name, $variation->secondary_name, true) !!} @if($variation->product_type == 'variable') - {{$variation->product_variation_name}} - {{$variation->name}} @endif</h4>
		</div>
		<div class="box-body">
			<div class="row">
				<div class="col-md-12">
