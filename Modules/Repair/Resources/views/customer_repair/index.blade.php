        ...
        <div class="col-md-4">
            <div
                ...
                <div class="tw-flex tw-flex-col tw-gap-4 tw-dw-rounded-box tw-dw-p-6 tw-dw-max-w-md">
                    ...
                    @endphp
                    <form form method="POST" action="{{action([\Modules\Repair\Http\Controllers\CustomerRepairStatusController::class, 'postRepairStatus'])}}" id="check_repair_status">
                        {{ csrf_field() }}
                            <label class="tw-dw-form-control">
                                <div class="tw-dw-label">
                                    <span
                                        class="tw-text-xs md:tw-text-sm tw-font-medium tw-text-black">@lang('lang_v1.search_by')</span>
                                </div>
							...
							<label class="tw-dw-form-control">
								{!! Form::text('search_number', null, ['class' => 'tw-border tw-border-[#D1D5DA] tw-outline-none tw-h-12 tw-bg-transparent tw-rounded-lg tw-px-3 tw-font-medium tw-text-black placeholder:tw-text-gray-500 placeholder:tw-font-medium', 'required', 'placeholder' => $placeholder]); !!}
                            </label>
							<label class="tw-dw-form-control">
								<input type="text" name="serial_no" class="tw-border tw-border-[#D1D5DA] tw-outline-none tw-h-12 tw-bg-transparent tw-rounded-lg tw-px-3 tw-font-medium tw-text-black placeholder:tw-text-gray-500 placeholder:tw-font-medium" id="repair_serial_no" placeholder="@lang('repair::lang.serial_no')">
                            </label>
                        <button type="submit"
