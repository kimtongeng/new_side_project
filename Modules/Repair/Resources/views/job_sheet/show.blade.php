                        ...
                        <div class="box-tools">
                            @if (auth()->user()->can('job_sheet.edit'))
                                <a href="{{ action([\Modules\Repair\Http\Controllers\JobSheetController::class, 'edit'], [$job_sheet->id]) }}"
                                    class="tw-dw-btn tw-dw-btn-info tw-text-white tw-dw-btn-sm cursor-pointer">
                            ...
                            <a class="tw-dw-btn tw-dw-btn-success tw-text-white tw-dw-btn-sm"
                            ...
                            <a class="tw-dw-btn tw-dw-btn-error tw-text-white tw-dw-btn-sm"
