    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            try {
                ...
                TelegramNotification::purchasePaymentDueAlertMessage('home', $location_id, $transaction->id);
            } catch (\Exception $te) {
                \Log::warning('Telegram purchase payment due alert failed: ' . $te->getMessage());
            }
            ...
            AND deleted_at IS NULL) AS balance"),
                ...
                \Log::warning('Telegram purchase notification failed: ' . $te->getMessage());
            }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            try {
                ...
                // Load old transaction relations from the replicated snapshot
                $transaction_before->load([
                    'purchase_lines.product.unit',
                    'purchase_lines.variations',
                ]);
            ...
            AND deleted_at IS NULL) AS balance"),
                ...
                \Log::warning('Telegram purchase update notification failed: ' . $te->getMessage());
            }
                ...
                try {
                    ...
                    $all_account = Account::where('business_id', $business_id)
                      ...
                      AND deleted_at IS NULL) as balance")
                        ...
                        ->toArray();
                    \App\Notifications\TelegramNotification::deletePurchaseMessage(
                        $transaction,
                        $payment_types,
                        $all_account,
                        'purchase',
                    ...
                    \Log::warning('Telegram purchase delete notification failed: ' . $te->getMessage());
                }
                // ── End Telegram Notification ──────────────────────────
        ...
        try {
            ...
            try {
                ...
                $all_account = Account::where('business_id', $business_id)
                    ...
                    ->toArray();
                \App\Notifications\TelegramNotification::updatePurchaseStatusMessage(
                    $transaction,
                    $before_status,
                    $all_account,
                    'purchase',
                ...
                \Log::warning('Telegram purchase status notification failed: ' . $te->getMessage());
            }
            // ── End Telegram Notification ──────────────────────────
