...
class TransactionUtil extends Util
{
    ...
    public function getReceiptDetails($transaction_id, $location_id, $invoice_layout, $business_details, $location_details, $receipt_printer_type, $is_delete = false)
    {
        ...
        $output = [
            ...
            "repair_brand_id" => $transaction->repair_brand_id,
            "repair_status_id" => $transaction->repair_status_id,
            "repair_model_id" => $transaction->repair_model_id,
            "repair_job_sheet_id" => $transaction->repair_job_sheet_id,
            "repair_defects" => $transaction->repair_defects,
            "repair_serial_no" => $transaction->repair_serial_no,
            "repair_checklist" => $transaction->repair_checklist,
            "repair_security_pwd" => $transaction->repair_security_pwd,
            "repair_security_pattern" => $transaction->repair_security_pattern,
            "repair_due_date" => $transaction->repair_due_date,
            "repair_device_id" => $transaction->repair_device_id,
            "repair_updates_notif" => $transaction->repair_updates_notif,
            'repair_completed_on' => $transaction->repair_completed_on,
